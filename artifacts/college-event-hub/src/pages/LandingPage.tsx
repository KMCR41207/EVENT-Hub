...
export default function LandingPage() {
  ...
  const heroFade = useTransform(scrollYProgress, [0, 0.12], [1, 0.4]);
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 px-4 max-w-7xl mx-auto pt-24">
          <motion.div
            className="grid gap-12 items-center lg:grid-cols-[1.2fr_1fr]"
          ...
          >
            <div>
              ...
              <h1 className="font-display font-extrabold text-5xl sm:text-6xl md:text-7xl leading-[0.92] tracking-tight mb-6 max-w-3xl">
                <span className="block text-foreground">Discover the best campus events.</span>
                <span className="block bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">
                  Real-time registration, QR attendance, and community impact.
                </span>
              </h1>

              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mb-10 leading-relaxed">
                EventHub turns student life into a modern campus experience with polished discovery, effortless sign-up, and instant QR check-in.
              </p>
              ...
              <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
                {[
                  ...
                  { label: "Attendees", value: summary?.totalRegistrations ?? "--" },
                  { label: "Upcoming", value: summary?.upcomingEventsCount ?? "--" },
                ].map((stat) => (
                  <div key={stat.label} className="glass-panel rounded-3xl py-5 px-4 text-center">
            ...
            <motion.div
              ...
              style={{ opacity: heroFade }}
            >
              <div className="relative rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl shadow-primary/20 ring-1 ring-white/10 backdrop-blur-xl overflow-hidden">
                ...
                <div className="relative z-10 space-y-6">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      <p className="text-xs uppercase tracking-[0.35em] text-primary/80">Quick Check-in</p>
                      <h3 className="font-display font-semibold text-2xl text-foreground mt-2">QR pass ready</h3>
                    </div>
                    <div className="text-right">
                      <p className="text-sm text-muted-foreground">Event</p>
                      <p className="font-semibold text-3xl text-foreground">Immerse</p>
                    </div>
                  </div>
                  <div className="rounded-3xl border border-white/10 bg-background/90 p-6">
                    <div className="aspect-square rounded-3xl bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white text-4xl font-bold shadow-xl shadow-primary/20">
                      QR
                    </div>
                    <div className="mt-6 grid gap-3 text-sm text-muted-foreground">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-foreground">Seats left</span>
                        <span>24</span>
                      </div>
                    </div>
                  </div>
