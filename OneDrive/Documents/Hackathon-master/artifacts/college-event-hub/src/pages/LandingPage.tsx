...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      {/* Club Marquee — only shown when clubs exist */}
      {clubMarqueeNames.length > 0 && (
      <section className="py-12 border-y border-border overflow-hidden">
        <div className="flex">
          <motion.div className="flex items-center gap-8 whitespace-nowrap animate-marquee">
            {clubMarqueeNames.map((name, i) => (
      ...
      <section className="py-24 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            {!Array.isArray(events) && Array.from({ length: 6 }).map((_, i) => (
