      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Button asChild variant="outline" className="rounded-full font-medium border-[#e11d2e] text-[#e11d2e] hover:bg-[#e11d2e] hover:text-white transition-colors">
          ...
          >
            <div className="px-4 pt-2 pb-6 space-y-1">
              ...
              <div className="pt-4 px-3 flex flex-col gap-2">
                ...
                <Button asChild variant="outline" className="w-full rounded-full border-[#e11d2e] text-[#e11d2e] hover:bg-[#e11d2e] hover:text-white">
                  <Link href="/admin" onClick={() => setIsOpen(false)}>Admin Portal</Link>
                </Button>
              </div>
            </div>
          </motion.div>
